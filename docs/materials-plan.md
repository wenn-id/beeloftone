...
| 2 Core Operations | Production orders, partial WIP, basic QC, issues and audit exist. This increment adds raw materials, batch receipt and issue to production orders. |
