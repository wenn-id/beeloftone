...
| Pemeriksaan | Hasil |
|---|---|
| `python -m unittest discover -s tests` | 367 test, OK. Sebelumnya 354; 13 test baru. |
...
| `python tests/run_browser.py --channel chromium` | 62 modul acceptance PASS. Sebelumnya 61; 1 modul baru. |
