...
(async () => {
  ...
  await require('./browser_wip_ageing_insights.cjs')({page,login,viewer,apiGet,work});
  await require('./browser_production_capacity.cjs')({page,login,admin,viewer,apiGet,apiPost,work});
  await require('./browser_workforce.cjs')({page,login,admin,operator,viewer,apiPost,work});
  ...
  await require('./browser_payroll_approvals.cjs')({page,login,admin,operator,viewer,apiGet,apiPost,work});
  await require('./browser_payroll_payment_reconciliation.cjs')({page,login,admin,viewer,apiPost,work});
  await require('./browser_payroll_accounting_reconciliation.cjs')({page,login,admin,viewer,apiPost,work});
  ...
  await require('./browser_workforce_approvals.cjs')({page,login,admin,operator,viewer,apiGet,apiPost,work});
