BEGIN IMMEDIATE;
ALTER TABLE warehouse_movements ADD COLUMN scanned_code TEXT
    CHECK(scanned_code IS NULL OR (scanned_code=trim(scanned_code) AND length(scanned_code) BETWEEN 1 AND 200));
