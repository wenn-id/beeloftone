...
approval, serta analitik dan AI. Versi aplikasi 0.104.0, schema database 55.
...
Suite Python berisi 1113 test yang memakai database sementara serta API/CLI sungguhan; mencakup
...
- [Command Center Apple-27 A5](docs/apple27-command-center-golden.md) — komposisi, sumber data,
  batas material, aksesibilitas, dan bukti validasi lokal versi 0.104.0.
